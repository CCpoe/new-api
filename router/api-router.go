...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/alipay/notify", anonymousRequestBodyLimit, controller.AlipayNotify)
		apiRouter.POST("/lakala/notify", anonymousRequestBodyLimit, controller.LakalaNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/recharge-shop", controller.GetRechargeShop)
				...
				selfRoute.POST("/lakala/pay", middleware.CriticalRateLimit(), controller.RequestLakalaPay)
				selfRoute.POST("/lakala/amount", controller.RequestLakalaAmount)
