...
export function Checkbox({
  ...
  return (
    ...
    >
      ...
      {label && (
        <span className="text-[13px] font-medium text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-100 transition-colors select-none">
          {label}
        </span>
      )}
    </label>
