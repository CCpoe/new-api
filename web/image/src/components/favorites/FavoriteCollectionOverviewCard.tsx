...
export function FavoriteCollectionOverviewCard({
  ...
  return (
    <div className="relative rounded-xl">
      <div
        className={`absolute inset-0 rounded-xl flex items-center transition-opacity duration-200 pointer-events-none ${isSwiping || swipeDirection !== 0 || swipeActionActive ? "opacity-100" : "opacity-0"} ${swipeBgClass} ${swipeDirection > 0 ? "justify-start pl-6" : "justify-end pr-6"}`}
      >
        <svg
