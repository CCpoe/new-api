...
export function FavoriteCollectionPickerModal() {
  ...
  const handleDelete = (
    ...
    const collectionTasks = tasks.filter((t) =>
      getTaskFavoriteCollectionIds(t).includes(collection.id),
    );
          ...
          <div className="flex items-center justify-between mb-1.5 px-6 shrink-0">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="text-[13px] font-medium text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300 transition-colors"
              >
                全选
              </button>
              <button
                ...
                className="text-[13px] font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 transition-colors"
              >
                取消
              </button>
            </div>
                      ...
                      {editingId === collection.id ? (
                        ...
                        <>
                          <FavoriteActionButton
                            ...
                            className={`p-1.5 hover:bg-gray-200 dark:hover:bg-white/10 rounded-md transition-colors ${isDefault ? "text-yellow-500 dark:text-yellow-400" : "text-gray-400 hover:text-yellow-500 dark:hover:text-yellow-400"}`}
                          >
                            <FavoriteIcon
                              filled={isDefault}
                              className="w-3.5 h-3.5"
                          ...
                          <FavoriteActionButton
                            ...
                            className="p-1.5 hover:bg-gray-200 dark:hover:bg-white/10 rounded-md text-gray-400 hover:text-gray-700 dark:hover:text-white transition-colors"
                          >
                          ...
                          <FavoriteActionButton
                            ...
                            className={`p-1.5 hover:bg-gray-200 dark:hover:bg-white/10 rounded-md transition-colors ${canDelete ? "text-gray-400 hover:text-red-500 dark:hover:text-red-400" : "text-gray-300 dark:text-gray-600 cursor-not-allowed"}`}
                          >
        ...
        <div className="border-t border-gray-200 p-6 dark:border-[#333] shrink-0">
          ...
          <div className="mt-5 flex gap-4">
            <button
              type="button"
              onClick={closePicker}
              className="flex-1 rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors dark:border-white/10 dark:text-gray-200 dark:hover:bg-white/[0.04]"
            >
              取消
            </button>
            <button
              ...
              className="flex-1 rounded-xl bg-blue-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-600 transition-colors shadow-sm border border-transparent"
            >
              确认
            </button>
          </div>
