...
const RAW_DEFAULT_API_URL = readRuntimeEnv(
...
const SHOW_DEFAULT_CONFIG_ONLY =
...
export function isDefaultConfigOnlyEnabled(): boolean {
  return (
    ...
    (Boolean(RAW_DEFAULT_API_URL) || DEFAULT_OPENAI_API_PROXY)
  );
}

function normalizeReferenceImageEditAction(
  value: unknown,
): ReferenceImageEditAction {
...
export function normalizeSettings(
  ...
  return {
    ...
    referenceImageEditAction: normalizeReferenceImageEditAction(
