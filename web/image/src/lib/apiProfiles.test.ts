...
describe("default API URL env", () => {
  it("applies shared URL params from VITE_DEFAULT_API_URL to the default profile", async () => {
    ...
    vi.stubEnv(
      ...
      "https://app.example.com/?apiUrl=https%3A%2F%2Fapi.example.com&apiMode=images&model=test-image-model&profileName=URL%20Profile&codexCli=true&streamImages=true&streamPartialImages=3",
    );
