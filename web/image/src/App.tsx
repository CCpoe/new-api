...
import { applyKkcodeSettings } from "./lib/kkcodeSettings";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const applyUrlSettings = (baseSettings: Partial<AppSettings>) => {
      ...
      const resolvedSettings = Object.keys(nextSettings).length
        ? nextSettings
        : baseSettings;
      return applyKkcodeSettings(resolvedSettings, searchParams);
    };
    ...
    if (
      ...
      defaultConfigOnly &&
      !customProviderConfigUrlImportStarted
    ) {
